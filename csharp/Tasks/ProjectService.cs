...
namespace Tasks
{
    public class ProjectService
    {
        ...
        public void AddTask(List<Project> projectsList,string project, string description, long taskId)
        {
        ...
        public Task GetTask(List<Project> projects, int id)
        {
